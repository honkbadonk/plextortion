...
Download Plextortion.exe from Releases
Double-click to run (Windows SmartScreen may warn - click "More info" → "Run anyway")
...
Click Add Webhook
Enter: http://YOUR_IP:5555/webhook
Click Save Changes
...
DeviceLock MessageUnlock MessageApple TV✅✅Fire Stick✅❌Chrome Browser✅❌Samsung TVTestingTestingGoogle TVTestingTesting
